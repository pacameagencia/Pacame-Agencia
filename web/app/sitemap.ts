...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/casos-3d`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${BASE_URL}/encuentra-tu-solucion`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/herramientas`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE_URL}/herramientas/generador-slogan`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/herramientas/analisis-competencia`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/herramientas/color-palette-brand`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/herramientas/calculadora-pricing`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/herramientas/calendario-contenido`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
