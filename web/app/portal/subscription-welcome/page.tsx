    ...
    <div className="min-h-screen bg-paper text-ink flex items-center justify-center px-4">
      <div className="max-w-xl w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/portal"
            className="inline-flex items-center justify-center gap-2 bg-white/[0.06] hover:bg-white/[0.1] border border-white/10 text-ink font-heading font-medium px-6 py-3 rounded-xl transition"
          >
            Iniciar sesion
          </Link>
        </div>
