  ...
  return (
    <section className="py-12 border-y border-white/[0.04]">
      <div className="max-w-6xl mx-auto px-6">
        <p className="text-center text-pacame-white/30 font-body text-sm mb-8 uppercase tracking-wider">
          Confian en nosotros
        </p>
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          {companies.map((name) => (
            <span
              key={name}
              className="text-pacame-white/20 font-heading font-semibold text-sm sm:text-base whitespace-nowrap hover:text-pacame-white/40 transition-colors"
            >
              {name}
            </span>
          ))}
      ...
      <div className="max-w-6xl mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="inline-block px-3 py-1 rounded-full bg-lime-pulse/10 text-lime-pulse text-xs font-heading font-semibold mb-4">
              La solucion
            </span>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {solutions.map((sol) => (
            <StaggerItem key={sol.title}>
              <div className="rounded-2xl bg-dark-card border border-lime-pulse/10 hover:border-lime-pulse/30 transition-colors p-6 h-full">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-lime-pulse/10 flex items-center justify-center flex-shrink-0">
                    <Check className="w-6 h-6 text-lime-pulse" />
                  </div>
                  <div>
  ...
  return (
    <section className="py-20 lg:py-28 bg-white/[0.02]">
      <div className="max-w-4xl mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="inline-block px-3 py-1 rounded-full bg-electric-violet/10 text-electric-violet text-xs font-heading font-semibold mb-4">
              El proceso
            </span>
            <h2 className="font-heading font-bold text-3xl sm:text-4xl text-pacame-white">
              Como funciona
          ...
          {steps.map((step, idx) => (
            <ScrollReveal key={step.step} delay={idx * 0.1}>
              <div className="flex items-start gap-6">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-electric-violet to-olympus-gold flex items-center justify-center flex-shrink-0">
                  <span className="font-heading font-bold text-lg text-white">
                    {step.step}
                  </span>
                </div>
                <div>
                  <h3 className="font-heading font-semibold text-xl text-pacame-white mb-1">
                    {step.title}
                  </h3>
                  <p className="text-pacame-white/50 font-body text-sm leading-relaxed">
                    {step.description}
  ...
  return (
    <section className="py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-6">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="inline-block px-3 py-1 rounded-full bg-olympus-gold/10 text-olympus-gold text-xs font-heading font-semibold mb-4">
              Resultados reales
            </span>
            <h2 className="font-heading font-bold text-3xl sm:text-4xl text-pacame-white">
  ...
  return (
    <section className="py-20 lg:py-28 bg-white/[0.02]">
      <div className="max-w-lg mx-auto px-6">
        <ScrollReveal>
          <div className="rounded-2xl border-2 border-electric-violet/30 bg-dark-card p-8 sm:p-10 text-center relative overflow-hidden">
            {/* Glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 bg-electric-violet/10 blur-3xl rounded-full" />

            <div className="relative">
              <Sparkles className="w-6 h-6 text-electric-violet mx-auto mb-4" />
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="font-heading font-bold text-5xl text-pacame-white">
                  {price}
                </span>
                <span className="font-heading text-2xl text-pacame-white/50">
                  &euro;
                </span>
                {recurring && (
                  <span className="text-pacame-white/40 font-body text-sm">
                    /mes
                  </span>
                )}
              </div>
              ...
              <ul className="mt-8 space-y-3 text-left">
                {[
                  ...
                  >
                    <Check className="w-4 h-4 text-lime-pulse flex-shrink-0 mt-0.5" />
                    {item}
                  </li>
                ))}
              </ul>
              ...
              <p className="mt-4 text-pacame-white/30 font-body text-xs">
          ...
          {faqs.map((faq, idx) => (
            <ScrollReveal key={faq.q} delay={idx * 0.05}>
              <div className="rounded-2xl bg-dark-card border border-white/[0.06] hover:border-white/10 transition-all overflow-hidden">
                ...
                >
                  <h3 className="font-heading font-semibold text-base text-pacame-white pr-4">
                    {faq.q}
                  </h3>
                  <ChevronDown
                    className={`w-5 h-5 text-pacame-white/40 flex-shrink-0 transition-transform duration-300 ${
  ...
  return (
    <section className="py-20 lg:py-28 bg-white/[0.02]">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <ScrollReveal>
          <Zap className="w-8 h-8 text-olympus-gold mx-auto mb-6" />
          <h2 className="font-heading font-bold text-3xl sm:text-4xl text-pacame-white mb-4">
            Tu competencia ya tiene landing page.
            <br />
            <span className="text-olympus-gold">Y tu?</span>
          </h2>
          <p className="text-pacame-white/50 font-body text-lg mb-10 max-w-xl mx-auto">
