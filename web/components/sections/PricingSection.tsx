...
export default function PricingSection() {
  return (
    <section className="section-padding bg-pacame-black" id="paquetes">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading font-bold text-section text-pacame-white mb-6">
            Precios claros.
            <br />
            <span className="gradient-text">Sin sorpresas en la factura.</span>
          </h2>
          <p className="text-lg text-pacame-white/60 max-w-xl mx-auto font-body">
            Combina servicios y ahorra. O elige sólo lo que necesitas.
            En cualquier caso, siempre sabrás exactamente lo que pagas.
          </p>
        </div>
            ...
            >
              {pkg.featured && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <div className="flex items-center gap-1.5 bg-pacame-white rounded-full px-4 py-1.5">
              ...
              <Button
                ...
                className={`w-full group ${
                  pkg.featured ? "bg-white/20 border-white/30 text-white hover:bg-white/30" : ""
                }`}
                asChild
              >
                <Link href="/contacto">
        ...
        <p className="text-center text-sm text-pacame-white/40 font-body">
          ...
          <Link href="/contacto" className="text-electric-violet hover:text-electric-violet/80 transition-colors">
