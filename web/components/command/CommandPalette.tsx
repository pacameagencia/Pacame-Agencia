...
const ITEMS: CommandItem[] = [
  ...
  { id: "pub:herramientas", label: "Herramientas gratis", hint: "8 tools: slogan, paleta, pricing, calendario", href: "/herramientas", icon: Sparkles, section: "Sitio publico" },
  { id: "pub:quiz", label: "Encuentra tu solucion", hint: "Quiz 2 min con recomendacion", href: "/encuentra-tu-solucion", icon: Sparkles, section: "Sitio publico" },
