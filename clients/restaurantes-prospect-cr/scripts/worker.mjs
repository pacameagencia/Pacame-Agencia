...
// getWebScreenshot + buildConfig extraídos a ../lib/build-config.mjs
// (para poder generar demos sin arrancar el worker).

// buildConfig vive en ../lib/build-config.mjs (importado arriba).
