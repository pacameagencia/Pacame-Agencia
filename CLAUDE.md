...
1. **Pagos reales con dinero** — `stripe charge`, transferencias, compra de creditos en APIs externas, **crear productos/precios live en Stripe**
...
- Cualquier caso de la regla maestra (`feedback_autonomia_total`): pago real, borrado masivo en prod, `push --force` a main, **crear productos Stripe live**
