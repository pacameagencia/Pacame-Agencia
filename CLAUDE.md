...
| **Antes de CUALQUIER generación visual/video/copy Dark Room** (Higgsfield, Soul, Nano Banana Pro, Cinematic Studio, Seedance, Kling, Veo, concept 00X, 360 sheet, outfit transform, character substitution, formato 1-act/2-act/3-act/story/carrusel) | **Sistema definitivo unificado v1**: [`DARK-ROOM-PLAYBOOK.md`](strategy/darkroom/studio-config/DARK-ROOM-PLAYBOOK.md) (recipe card 1-página · 5 formatos canónicos) + [`DARK-ROOM-REFERENCE.md`](strategy/darkroom/studio-config/DARK-ROOM-REFERENCE.md) (detalle 14 secciones · 21 reglas duras · 6 style variants · 26 markers Three-Pass Review) + [`DARK-ROOM-TEMPLATE.json`](strategy/darkroom/studio-config/DARK-ROOM-TEMPLATE.json) (schema canonical validable). **Validation gate 3 capas obligatorio antes de render premium**: (1) `node tools/dark-frames/validate-concept.mjs <concept.json>` → exit 0; (2) hook [`infra/scripts/knowledge-gate-hook.py`](infra/scripts/knowledge-gate-hook.py); (3) subagente [`.claude/agents/concept-reviewer.md`](.claude/agents/concept-reviewer.md). Benchmarks WOW: [`tools/dark-frames/benchmarks/`](tools/dark-frames/benchmarks/). |
| **Antes de redactar / iterar / revisar contenido formativo Dark Academy** (lecciones, módulos, lead magnets, posts blog `/noticias`, newsletter quincenal, scripts video tutorial, procesamiento material fuente externo) | Subagente [`dark-academy`](.claude/agents/dark-academy.md) + currícula maestra [`strategy/darkroom/academy/curriculum.md`](strategy/darkroom/academy/curriculum.md) + arquitectura [`strategy/darkroom/academy/architecture.md`](strategy/darkroom/academy/architecture.md) + [`sources/_transformation-log.md`](strategy/darkroom/academy/sources/_transformation-log.md) (mapeo TXT fuente → módulos). Voz Dark Room (positioning.md), cero menciones PACAME, anti-plagio del TXT externo, capa diferencial PACAME (research-first + tier system + 21 reglas + Three-Pass Review). Quality-reviewer obligatorio antes de publicar. |
